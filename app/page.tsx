const androidDownloadUrl = 'downloads/Guanxiang-Android-v1.2.0.apk';
const iosStatusUrl = 'https://github.com/Heiaia1/guanxiang/blob/main/docs/ios-release-readme.md';
const githubUrl = 'https://github.com/Heiaia1/guanxiang';
const cooperationUrl = 'https://github.com/Heiaia1/guanxiang/issues/new?title=%E5%95%86%E4%B8%9A%E5%90%88%E4%BD%9C';
...
const features = [
  ...
  { number: '03', title: '30 天后回看', description: '把当下判断留在本机，到期后对照事实变化；不申请系统通知权限。' },
  { number: '04', title: '隐私留在本机', description: '无需登录、没有广告、无联网权限，问题与记录只保存在你的设备。' },
];
    ...
    <main>
      <nav className="nav shell" aria-label="主导航">
        ...
        <div className="nav-links">
          <a href="#features">功能</a><a href="#support">支持项目</a><a href="#install">安装说明</a><a href="#ios">iOS</a>
      ...
      <section className="hero shell" id="top">
        <div className="hero-copy">
          ...
          <p className="english-intro">A private, offline reflection companion inspired by classical Chinese change philosophy.</p>
        ...
        <div className="hero-visual qimen-visual" aria-label="风后奇门主题界面意象">
          ...
          <div className="phone">
            ...
            <div className="phone-screen">
              ...
              <h2>条件已理清</h2><p className="app-caption">看事实 · 选行动 · 再回看</p>
              <button type="button" tabIndex={-1}>安排 30 天回看</button>
      ...
      <section className="support shell" id="support">
        <div className="section-heading">
          <p className="eyebrow"><span /> 免费使用 · 持续成长</p>
          <h2>先让产品有价值，<br />再让合作有回报</h2>
          <p className="support-lead">核心观象、文化馆、札记、记录与 30 天回看保持免费。现阶段通过自然分享、GitHub 关注和商业定制获得增长，不用诱导分享换结果，也不接入未经验证的支付。</p>
        </div>
        <div className="support-list">
          <article><span>01</span><h3>自然分享</h3><p>分享项目介绍或文化卡片，不上传个人问题，不以奖励诱导转发。</p><a href={githubUrl} target="_blank" rel="noreferrer">关注 GitHub →</a></article>
          <article><span>02</span><h3>30 天回看</h3><p>让一次使用变成持续反思：到期后回到记录，对照事实与当时判断。</p><a href={androidDownloadUrl} download>免费下载体验 →</a></article>
          <article><span>03</span><h3>商业合作</h3><p>开放品牌联名、私有部署、内容定制与界面授权合作，需求通过公开工单留痕。</p><a href={cooperationUrl} target="_blank" rel="noreferrer">发起合作咨询 →</a></article>
        </div>
        <p className="payment-note">未来如上线数字增值服务，将按微信、Apple 与 Google Play 各自的支付规则分别接入；当前版本不展示虚假购买入口。</p>
      </section>
      ...
      <section className="install shell" id="install">
        ...
        <div className="install-steps">
          ...
          <a className="primary-button light-button" href={androidDownloadUrl} download>
            <span className="android-icon" aria-hidden="true">↓</span><span><strong>免费下载 APK</strong><small>v1.2.0 · Android 7.0+</small></span>
          </a>
        </div>
      </section>
      ...
      <footer className="shell footer">
        ...
        <div className="footer-links"><a href="https://github.com/Heiaia1/guanxiang/blob/main/docs/privacy-policy-ios.md">iOS 隐私</a><a href={githubUrl}>项目源码</a><a href={cooperationUrl}>商业合作</a></div>
      </footer>
    </main>
  );
}
