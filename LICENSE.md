...
1. 销售、出租、收费分发本软件或其修改版本；
2. 将本软件、其主要代码、内容库、界面或衍生版本用于商业产品、付费服务、广告获利服务或机构内部生产用途；
3. 换名、换皮后发布到应用商店、小程序平台、软件下载站或其他代码托管平台；
4. 删除、隐藏或误导性修改著作权、来源和许可说明；
5. 使用“观象录”名称、标识或容易造成官方关联误解的名称对外推广。

允许在保留本许可文件和原始来源说明的前提下，分享指向本 GitHub 仓库或官方 Release 页面的链接。镜像、再分发完整安装包或源码压缩包需要事先取得书面许可。

本软件按“现状”提供，不作任何明示或默示保证。使用者应自行判断其适用性并承担使用风险。本软件仅用于传统文化学习与个人反思，不构成医疗、法律、投资或其他专业意见。
